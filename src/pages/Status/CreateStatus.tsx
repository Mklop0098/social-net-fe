                    ...
                    <div className="grid md:grid-cols-5 xs:grid-cols-1 gap-1">
                        <div className="shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                            <div className="shadow-l-md xs:hidden md:block flex flex-col">
                                ...
                                {
                                    ready && <div className="p-4 flex flex-col justify-between">
                                        <div>
                                            <div className="textarea-label rounded-lg">
                                                <p className="ml-[12px] text-sm mt-2">Văn bản</p>
                                                <TextareaAutosize className="textarea-style" minRows={6} maxRows={6} onChange={e => setValue(e.target.value)} />
                                            </div>
                                        ...
                                        <div className="flex flex-row items-center justify-evenly mt-12">
                                            <button className="bg-gray-200 py-2 px-12 rounded-md" onClick={() => {
                                                setReady(false)
                                                setValue('')
                                            }}>Bỏ</button>
                                            <button className="bg-[--primary-color] text-white py-2 px-12 rounded-md">Chia sẻ lên tin</button>
                                        </div>
                                    </div>
                                }
                        ...
                        <div className="h-[93vh] overflow-auto w-full flex items-center justify-center col-span-4 bg-gray-200">
                            {
                                !ready ? <div className="w-[220px] h-[330px] m-auto bg-gradient-to-tr from-indigo-600 via-red-400 to-purple-600 rounded-xl flex items-center justify-center" onClick={() => setReady(true)}>
                                    <div className="flex flex-col items-center">
                                        <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                                            <PiTextAaBold />
                                        </div>
                                        <span className="font-semibold text-white mt-4">Tạo tin dạng văn bản</span>
                                    </div>
                                </div> :
                                    <div className="w-[900px] h-[900px] bg-white flex flex-col shadow-lg p-6 rounded-lg">
                                        ...
                                        <div className="flex-1 bg-black rounded-lg mt-3 flex items-center justify-center">
                                            <div className="h-[96%] w-[50%] bg-red-100 m-auto rounded-lg flex items-center justify-center"
                                                style={{
                                            ...
                                            >
                                                {
                                                    value !== '' ?
                                                        <TextareaAutosize value={value} className="textarea-show" maxRows={12} minRows={1} /> :
